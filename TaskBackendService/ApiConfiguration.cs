...
using System;
using TaskBackendService.App_Start;
using TaskBackendService.Utilities;
using TaskBackendService.Configuration;
using TaskBackendService.Services;
using TaskBackendService.Authentication;
using TaskBackendService.Filters;
...
namespace TaskBackendService
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "TaskBackendService"))
                .EnableSwaggerUi();
